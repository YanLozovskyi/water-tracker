...
`;const M3="src/assets/images/default_avatar_to_download.jpg",U3=Zx().shape({gender:Ur().required("Required"),username:Ur().min(3,"Username must be more then 3 characters long").max(32,"Username must be less then 32 characters long").required("Required"),email:Ur().email("Invalid email").required("Required"),newPassword:Ur().min(8,"New password must be at least 8 characters long").max(64,"New password must be less then 64 characters long").required("Required"),oldPassword:Ur().min(8,"Old password must be at least 8 characters long").max(64,"Old password must be less then 64 characters long").required("Required")}),B3=({onClose:e})=>{const[t,n]=w.useState(),[r,i]=w.useState(),[o,a]=w.useState(!1),s=w.forwardRef(null),l=()=>{s.current.click()},u=()=>{a(f=>!f)};return w.useEffect(()=>{if(!t)return;const f=URL.createObjectURL(t[0]);return i(f),()=>{URL.revokeObjectURL(f)}},[t]),b.jsx(b.Fragment,{children:b.jsx(Bl,{onClose:e,title:"Setting",children:b.jsx(N3,{children:b.jsx(p3,{initialValues:{avatar:"",gender:"",username:"",email:"",oldPassword:"",newPassword:"",repeatedPassword:""},validationSchema:U3,onSubmit:(f,c)=>{console.log(f),c.resetForm()},children:({values:f,errors:c,touched:d})=>b.jsxs(Aw,{children:[b.jsxs(Fy,{children:[b.jsx(Up,{children:"Your photo"}),b.jsxs(T3,{children:[b.jsx(A3,{src:r||M3,alt:"user avatar",width:"80px",height:"80px"}),b.jsxs("label",{children:[b.jsx($3,{ref:s,type:"file",name:"avatar",accept:"image/png, image/jpeg",onChange:v=>{v.target.files&&v.target.files.length>0&&n(v.target.files)}}),b.jsxs(P3,{type:"button",onClick:l,children:[b.jsx(Fw,{children:b.jsx("use",{href:`${kt}#icon-arrow-up`})}),b.jsx(C3,{children:"Upload a photo"})]})]})]})]}),b.jsxs(z3,{children:[b.jsxs(Dy,{children:[b.jsxs(D3,{children:[b.jsx(j3,{children:"Your gender identity"}),b.jsxs(R3,{children:[b.jsxs(zy,{children:[b.jsx(Iy,{type:"radio",name:"gender",value:"Girl",checked:f.gender==="Girl"}),b.jsx(Ly,{children:"Girl"})]}),b.jsxs(zy,{children:[b.jsx(Iy,{type:"radio",name:"gender",value:"Man",checked:f.gender==="Man"}),b.jsx(Ly,{children:"Man"})]})]})]}),b.jsxs(Fy,{children:[b.jsx(Ay,{htmlFor:"username",children:"Your name"}),c.username&&d.username?b.jsx(Xi,{type:"text",id:"username",name:"username",placeholder:f.username}):b.jsx(Br,{type:"text",id:"username",name:"username",placeholder:f.username}),b.jsx(Na,{component:"p",name:"username"})]}),b.jsxs(My,{children:[b.jsx(Ay,{htmlFor:"email",children:"E-mail"}),c.email&&d.email?b.jsx(Xi,{type:"email",id:"email",name:"email",placeholder:f.email}):b.jsx(Br,{type:"email",id:"email",name:"email",placeholder:f.email}),b.jsx(Na,{component:"p",name:"email"})]})]}),b.jsxs(Dy,{children:[b.jsx(I3,{children:"Password"}),b.jsxs(Ny,{children:[b.jsx(tc,{htmlFor:"oldPassword",children:"Outdated password:"}),b.jsxs(ec,{children:[c.oldPassword&&d.oldPassword?b.jsx(Xi,{type:o?"text":"password",id:"oldPassword",name:"oldPassword",placeholder:"Password"}):b.jsx(Br,{type:o?"text":"password",id:"oldPassword",name:"oldPassword",placeholder:"Password"}),b.jsx(Zu,{type:"button",onClick:u,children:o?b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-open`})}):b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-hide`})})})]}),b.jsx(Na,{component:"p",name:"oldPassword"})]}),b.jsxs(Ny,{children:[b.jsx(tc,{htmlFor:"password",children:"New Password:"}),b.jsxs(ec,{children:[c.newPassword&&d.newPassword?b.jsx(Xi,{type:o?"text":"password",id:"password",name:"newPassword",placeholder:"Password"}):b.jsx(Br,{type:o?"text":"password",id:"password",name:"newPassword",placeholder:"Password"}),b.jsx(Zu,{type:"button",onClick:u,children:o?b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-open`})}):b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-hide`})})})]}),b.jsx(Na,{component:"p",name:"newPassword"})]}),b.jsxs(My,{children:[b.jsx(tc,{htmlFor:"repeatedPassword",children:"Repeat new password:"}),b.jsxs(ec,{children:[f.newPassword!==f.repeatedPassword?b.jsx(Xi,{type:o?"text":"password",id:"repeatedPassword",name:"repeatedPassword",placeholder:"Password"}):b.jsx(Br,{type:o?"text":"password",id:"repeatedPassword",name:"repeatedPassword",placeholder:"Password"}),b.jsx(Zu,{type:"button",onClick:u,children:o?b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-open`})}):b.jsx(Mr,{children:b.jsx("use",{href:`${kt}#icon-to-hide`})})})]}),f.newPassword!==f.repeatedPassword?b.jsx(F3,{children:`The entered password doesn't matches the new
