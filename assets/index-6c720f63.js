...
`,eF=()=>{const[e,t]=w.useState(!1),{userName:n,avatarURL:r}=jr(Dx),i=()=>{t(!e)},o=n?n.charAt(0).toUpperCase():"V",a=()=>n&&r?{name:n,avatar:r}:n?{name:n,avatar:o}:{name:o,avatar:o},{name:s,avatar:l}=a();return b.jsxs(q3,{children:[b.jsx(Y3,{children:s}),b.jsxs(Q3,{onClick:i,children:[r?b.jsx(X3,{src:l,alt:""}):b.jsx(J3,{children:l}),b.jsx(Z3,{children:b.jsx("use",{href:`${kt}#icon-arrow-down`})})]}),e&&b.jsx(nF,{})]})},tF=$.div`
  position: absolute;
  top: 38px;
  left: -53px;
  width: 118px;
...
`,nF=()=>{const[e,t]=w.useState(!1),[n,r]=w.useState(!1),i=()=>{t(!0)},o=()=>{t(!1)},a=()=>{r(!0)},s=()=>{r(!1)};return b.jsx(b.Fragment,{children:b.jsx(tF,{children:b.jsxs("ul",{children:[b.jsxs(Vy,{children:[b.jsx(Uy,{width:"16px",height:"16px",children:b.jsx("use",{href:`${kt}#icon-settings`})}),b.jsxs(By,{type:"button",onClick:i,children:["Setting",e&&b.jsx(V3,{onClose:o})]})]}),b.jsxs(Vy,{children:[b.jsx(Uy,{width:"16px",height:"16px",children:b.jsx("use",{href:`${kt}#icon-exit`})}),b.jsxs(By,{type:"button",onClick:a,children:["Log out",n&&b.jsx(lF,{onClose:s})]})]})]})})})},rF=$.h2`
  margin-bottom: 24px;
  color: ${({theme:e})=>e.color.black};
  font-family: Roboto;
  font-size: 18px;
