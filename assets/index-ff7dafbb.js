...
`,gn="/water-tracker/assets/sprite-e80c8ed0.svg",zl=({onShow:e=!0,type:t,children:n,title:r,onClose:o})=>{const i=document.querySelector("#modal-root"),a=b.useRef(null),l=b.useRef(null);return b.useEffect(()=>{if(!e)return;const s=f=>{document.body.style.overflow=f?"hidden":"auto"};(e||i.children.length!==0)&&s(!0);const u=f=>{f.code==="Escape"&&o()};return window.addEventListener("keydown",u),()=>{window.removeEventListener("keydown",u)}},[i.children.length,e,o]),ff.createPortal(S.jsx(Q2,{onClick:o,ref:l,children:S.jsxs("div",{className:"modal-content",type:t,onClick:s=>s.stopPropagation(),ref:a,children:[S.jsxs("div",{className:"modal-header",children:[S.jsx("h2",{children:r}),S.jsx(Y2,{onClick:o,children:S.jsx(q2,{children:S.jsx("use",{href:`${gn}#icon-outline`})})})]}),S.jsx("div",{children:n})]})}),i)};zl.propTypes={onClose:uo.func.isRequired,children:uo.node.isRequired,onShow:uo.bool,title:uo.string.isRequired};const X2=C.div`
  margin: 0 auto;
  padding-right: 20px;
  padding-left: 20px;
...
`],[`
  animation: `,` 0.75s steps(12, end) infinite;
  animation-duration: `,`s;
`])),DE,IE("speed","0.75"));si.polyline(wh||(wh=Uf([`
  stroke-width: `,`px;
...
`,Wv=()=>S.jsx(UE,{children:S.jsx(ME,{height:"90",width:"90",radius:"9",color:"#407bff",ariaLabel:"three-dots-loading",visible:!0,timeout:2e3})});/**
 ...
 *
 * @license MIT
 */function Qo(){return Qo=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Qo.apply(this,arguments)}var yn;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(yn||(yn={}));const Fh="popstate";function BE(e){e===void 0&&(e={});function t(r,o){let{pathname:i,search:a,hash:l}=r.location;return qu("",{pathname:i,search:a,hash:l},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function n(r,o){return typeof o=="string"?o:Da(o)}return HE(t,n,null,e)}function me(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function Wf(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function WE(){return Math.random().toString(36).substr(2,8)}function Uh(e,t){return{usr:e.state,key:e.key,idx:t}}function qu(e,t,n,r){return n===void 0&&(n=null),Qo({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?Hr(t):t,{state:n,key:t&&t.key||r||WE()})}function Da(e){let{pathname:t="/",search:n="",hash:r=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function Hr(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function HE(e,t,n,r){r===void 0&&(r={});let{window:o=document.defaultView,v5Compat:i=!1}=r,a=o.history,l=yn.Pop,s=null,u=f();u==null&&(u=0,a.replaceState(Qo({},a.state,{idx:u}),""));function f(){return(a.state||{idx:null}).idx}function c(){l=yn.Pop;let w=f(),p=w==null?null:w-u;u=w,s&&s({action:l,location:m.location,delta:p})}function h(w,p){l=yn.Push;let d=qu(m.location,w,p);n&&n(d,w),u=f()+1;let y=Uh(d,u),x=m.createHref(d);try{a.pushState(y,"",x)}catch(E){if(E instanceof DOMException&&E.name==="DataCloneError")throw E;o.location.assign(x)}i&&s&&s({action:l,location:m.location,delta:1})}function v(w,p){l=yn.Replace;let d=qu(m.location,w,p);n&&n(d,w),u=f();let y=Uh(d,u),x=m.createHref(d);a.replaceState(y,"",x),i&&s&&s({action:l,location:m.location,delta:0})}function g(w){let p=o.location.origin!=="null"?o.location.origin:o.location.href,d=typeof w=="string"?w:Da(w);return me(p,"No window.location.(origin|href) available to create URL for href: "+d),new URL(d,p)}let m={get action(){return l},get location(){return e(o,a)},listen(w){if(s)throw new Error("A history only accepts one active listener");return o.addEventListener(Fh,c),s=w,()=>{o.removeEventListener(Fh,c),s=null}},createHref(w){return t(o,w)},createURL:g,encodeLocation(w){let p=g(w);return{pathname:p.pathname,search:p.search,hash:p.hash}},push:h,replace:v,go(w){return a.go(w)}};return m}var Bh;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(Bh||(Bh={}));function VE(e,t,n){n===void 0&&(n="/");let r=typeof t=="string"?Hr(t):t,o=Yo(r.pathname||"/",n);if(o==null)return null;let i=Hv(e);GE(i);let a=null;for(let l=0;a==null&&l<i.length;++l)a=tP(i[l],rP(o));return a}function Hv(e,t,n,r){t===void 0&&(t=[]),n===void 0&&(n=[]),r===void 0&&(r="");let o=(i,a,l)=>{let s={relativePath:l===void 0?i.path||"":l,caseSensitive:i.caseSensitive===!0,childrenIndex:a,route:i};s.relativePath.startsWith("/")&&(me(s.relativePath.startsWith(r),'Absolute route path "'+s.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),s.relativePath=s.relativePath.slice(r.length));let u=jn([r,s.relativePath]),f=n.concat(s);i.children&&i.children.length>0&&(me(i.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+u+'".')),Hv(i.children,t,f,u)),!(i.path==null&&!i.index)&&t.push({path:u,score:ZE(u,i.index),routesMeta:f})};return e.forEach((i,a)=>{var l;if(i.path===""||!((l=i.path)!=null&&l.includes("?")))o(i,a);else for(let s of Vv(i.path))o(i,a,s)}),t}function Vv(e){let t=e.split("/");if(t.length===0)return[];let[n,...r]=t,o=n.endsWith("?"),i=n.replace(/\?$/,"");if(r.length===0)return o?[i,""]:[i];let a=Vv(r.join("/")),l=[];return l.push(...a.map(s=>s===""?i:[i,s].join("/"))),o&&l.push(...a),l.map(s=>e.startsWith("/")&&s===""?"/":s)}function GE(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:eP(t.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const KE=/^:\w+$/,QE=3,YE=2,qE=1,XE=10,JE=-2,Wh=e=>e==="*";function ZE(e,t){let n=e.split("/"),r=n.length;return n.some(Wh)&&(r+=JE),t&&(r+=YE),n.filter(o=>!Wh(o)).reduce((o,i)=>o+(KE.test(i)?QE:i===""?qE:XE),r)}function eP(e,t){return e.length===t.length&&e.slice(0,-1).every((r,o)=>r===t[o])?e[e.length-1]-t[t.length-1]:0}function tP(e,t){let{routesMeta:n}=e,r={},o="/",i=[];for(let a=0;a<n.length;++a){let l=n[a],s=a===n.length-1,u=o==="/"?t:t.slice(o.length)||"/",f=Xu({path:l.relativePath,caseSensitive:l.caseSensitive,end:s},u);if(!f)return null;Object.assign(r,f.params);let c=l.route;i.push({params:r,pathname:jn([o,f.pathname]),pathnameBase:sP(jn([o,f.pathnameBase])),route:c}),f.pathnameBase!=="/"&&(o=jn([o,f.pathnameBase]))}return i}function Xu(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=nP(e.path,e.caseSensitive,e.end),o=t.match(n);if(!o)return null;let i=o[0],a=i.replace(/(.)\/+$/,"$1"),l=o.slice(1);return{params:r.reduce((u,f,c)=>{let{paramName:h,isOptional:v}=f;if(h==="*"){let m=l[c]||"";a=i.slice(0,i.length-m.length).replace(/(.)\/+$/,"$1")}const g=l[c];return v&&!g?u[h]=void 0:u[h]=oP(g||"",h),u},{}),pathname:i,pathnameBase:a,pattern:e}}function nP(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),Wf(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],o="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:(\w+)(\?)?/g,(a,l,s)=>(r.push({paramName:l,isOptional:s!=null}),s?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(r.push({paramName:"*"}),o+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?o+="\\/*$":e!==""&&e!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),r]}function rP(e){try{return decodeURI(e)}catch(t){return Wf(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function oP(e,t){try{return decodeURIComponent(e)}catch(n){return Wf(!1,'The value for the URL param "'+t+'" will not be decoded because'+(' the string "'+e+'" is a malformed URL segment. This is probably')+(" due to a bad percent encoding ("+n+").")),e}}function Yo(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,r=e.charAt(n);return r&&r!=="/"?null:e.slice(n)||"/"}function iP(e,t){t===void 0&&(t="/");let{pathname:n,search:r="",hash:o=""}=typeof e=="string"?Hr(e):e;return{pathname:n?n.startsWith("/")?n:aP(n,t):t,search:uP(r),hash:cP(o)}}function aP(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(o=>{o===".."?n.length>1&&n.pop():o!=="."&&n.push(o)}),n.length>1?n.join("/"):"/"}function $s(e,t,n,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function lP(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function Gv(e,t){let n=lP(e);return t?n.map((r,o)=>o===e.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function Kv(e,t,n,r){r===void 0&&(r=!1);let o;typeof e=="string"?o=Hr(e):(o=Qo({},e),me(!o.pathname||!o.pathname.includes("?"),$s("?","pathname","search",o)),me(!o.pathname||!o.pathname.includes("#"),$s("#","pathname","hash",o)),me(!o.search||!o.search.includes("#"),$s("#","search","hash",o)));let i=e===""||o.pathname==="",a=i?"/":o.pathname,l;if(a==null)l=n;else if(r){let c=t.length===0?[]:t[t.length-1].replace(/^\//,"").split("/");if(a.startsWith("..")){let h=a.split("/");for(;h[0]==="..";)h.shift(),c.pop();o.pathname=h.join("/")}l="/"+c.join("/")}else{let c=t.length-1;if(a.startsWith("..")){let h=a.split("/");for(;h[0]==="..";)h.shift(),c-=1;o.pathname=h.join("/")}l=c>=0?t[c]:"/"}let s=iP(o,l),u=a&&a!=="/"&&a.endsWith("/"),f=(i||a===".")&&n.endsWith("/");return!s.pathname.endsWith("/")&&(u||f)&&(s.pathname+="/"),s}const jn=e=>e.join("/").replace(/\/\/+/g,"/"),sP=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),uP=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,cP=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function fP(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const Qv=["post","put","patch","delete"];new Set(Qv);const dP=["get",...Qv];new Set(dP);/**
 ...
 *
 * @license MIT
 */function Fa(){return Fa=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Fa.apply(this,arguments)}function e0(e,t){if(e==null)return{};var n={},r=Object.keys(e),o,i;for(i=0;i<r.length;i++)o=r[i],!(t.indexOf(o)>=0)&&(n[o]=e[o]);return n}function AP(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function LP(e,t){return e.button===0&&(!t||t==="_self")&&!AP(e)}const zP=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],IP=["aria-current","caseSensitive","className","end","style","to","unstable_viewTransition","children"],DP=b.createContext({isTransitioning:!1}),MP="startTransition",Vh=Ns[MP];function FP(e){let{basename:t,children:n,future:r,window:o}=e,i=b.useRef();i.current==null&&(i.current=BE({window:o,v5Compat:!0}));let a=i.current,[l,s]=b.useState({action:a.action,location:a.location}),{v7_startTransition:u}=r||{},f=b.useCallback(c=>{u&&Vh?Vh(()=>s(c)):s(c)},[s,u]);return b.useLayoutEffect(()=>a.listen(f),[a,f]),b.createElement(TP,{basename:t,children:n,location:l.location,navigationType:l.action,navigator:a,future:r})}const UP=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",BP=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,WP=b.forwardRef(function(t,n){let{onClick:r,relative:o,reloadDocument:i,replace:a,state:l,target:s,to:u,preventScrollReset:f,unstable_viewTransition:c}=t,h=e0(t,zP),{basename:v}=b.useContext(In),g,m=!1;if(typeof u=="string"&&BP.test(u)&&(g=u,UP))try{let y=new URL(window.location.href),x=u.startsWith("//")?new URL(y.protocol+u):new URL(u),E=Yo(x.pathname,v);x.origin===y.origin&&E!=null?u=E+x.search+x.hash:m=!0}catch{}let w=pP(u,{relative:o}),p=VP(u,{replace:a,state:l,target:s,preventScrollReset:f,relative:o,unstable_viewTransition:c});function d(y){r&&r(y),y.defaultPrevented||p(y)}return b.createElement("a",Fa({},h,{href:g||w,onClick:m||i?r:d,ref:n,target:s}))}),Zu=b.forwardRef(function(t,n){let{"aria-current":r="page",caseSensitive:o=!1,className:i="",end:a=!1,style:l,to:s,unstable_viewTransition:u,children:f}=t,c=e0(t,IP),h=Ml(s,{relative:c.relative}),v=ci(),g=b.useContext(Yv),{navigator:m}=b.useContext(In),w=g!=null&&GP(h)&&u===!0,p=m.encodeLocation?m.encodeLocation(h).pathname:h.pathname,d=v.pathname,y=g&&g.navigation&&g.navigation.location?g.navigation.location.pathname:null;o||(d=d.toLowerCase(),y=y?y.toLowerCase():null,p=p.toLowerCase());const x=p!=="/"&&p.endsWith("/")?p.length-1:p.length;let E=d===p||!a&&d.startsWith(p)&&d.charAt(x)==="/",P=y!=null&&(y===p||!a&&y.startsWith(p)&&y.charAt(p.length)==="/"),O={isActive:E,isPending:P,isTransitioning:w},R=E?r:void 0,D;typeof i=="function"?D=i(O):D=[i,E?"active":null,P?"pending":null,w?"transitioning":null].filter(Boolean).join(" ");let I=typeof l=="function"?l(O):l;return b.createElement(WP,Fa({},c,{"aria-current":R,className:D,ref:n,style:I,to:s,unstable_viewTransition:u}),typeof f=="function"?f(O):f)});var ec;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(ec||(ec={}));var Gh;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Gh||(Gh={}));function HP(e){let t=b.useContext(Il);return t||me(!1),t}function VP(e,t){let{target:n,replace:r,state:o,preventScrollReset:i,relative:a,unstable_viewTransition:l}=t===void 0?{}:t,s=hP(),u=ci(),f=Ml(e,{relative:a});return b.useCallback(c=>{if(LP(c,n)){c.preventDefault();let h=r!==void 0?r:Da(u)===Da(f);s(e,{replace:h,state:o,preventScrollReset:i,relative:a,unstable_viewTransition:l})}},[u,s,f,r,o,n,e,i,a,l])}function GP(e,t){t===void 0&&(t={});let n=b.useContext(DP);n==null&&me(!1);let{basename:r}=HP(ec.useViewTransitionState),o=Ml(e,{relative:t.relative});if(!n.isTransitioning)return!1;let i=Yo(n.currentLocation.pathname,r)||n.currentLocation.pathname,a=Yo(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Xu(o.pathname,a)!=null||Xu(o.pathname,i)!=null}const Kh="/water-tracker/assets/Logo-890d13ba.png",Qh=C.img`
  width: 102px;
  height: 48px;
`,KP=e=>e.auth.user,QP=e=>e.auth.isLoggedIn,YP=()=>{const e=Wy(QP);return S.jsx("div",{children:e?S.jsx(Zu,{to:"/home",children:S.jsx(Qh,{src:Kh,alt:"logo"})}):S.jsx(Zu,{to:"/",children:S.jsx(Qh,{src:Kh,alt:"logo"})})})},qP=C.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding-top: 12px;
...
`,XP=()=>S.jsx("header",{children:S.jsx(X2,{children:S.jsxs(qP,{children:[S.jsx(YP,{}),S.jsx(O_,{})]})})}),JP="/water-tracker/assets/bottleMob-814a9d12.png",ZP="/water-tracker/assets/bottleMob@2x-17522dc3.png",e_="/water-tracker/assets/bottleTabl-c56ef88b.png",t_="/water-tracker/assets/bottleTabl@2x-5f20a434.png",n_="/water-tracker/assets/bottleDesc-5e7cc8f5.png",r_="/water-tracker/assets/bottleDesc@2x-cdf5cc76.png",Q_=C.div`
  display: flex;
  flex-direction: column;
  margin-top: 24px;
  margin-bottom: 16px;
...
`,f_=({onClose:e})=>{const[t,n]=b.useState("female"),[r,o]=b.useState(""),[i,a]=b.useState(""),[l,s]=b.useState("2.0"),[u,f]=b.useState(""),c=()=>{const v=t==="female"?.03:.04,g=t==="female"?.4:.6,m=(r*v+i/60*g).toFixed(2);s(m)},h=async()=>{c()};return S.jsx(zl,{onClose:e,title:"My daily norma",children:S.jsxs(o_,{children:[S.jsxs("div",{children:[S.jsxs(i_,{children:[S.jsxs(Ti,{children:["For girl: ",S.jsx("span",{children:"V=(M*0,03) + (T*0,4)"})]}),S.jsxs(Ti,{children:["For man: ",S.jsx("span",{children:"V=(M*0,04) + (T*0,6)"})]})]}),S.jsx(l_,{children:S.jsxs("p",{children:[S.jsx("span",{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})})]}),S.jsx("div",{children:S.jsxs(a_,{children:[S.jsxs(s_,{children:[S.jsx(Yh,{children:"Calculate your rate:"}),S.jsxs("label",{children:[S.jsx(qh,{type:"radio",name:"gender",value:"female",checked:t==="female",onChange:()=>n("female")}),S.jsx("span",{children:"For girl"})]}),S.jsxs("label",{children:[S.jsx(qh,{type:"radio",name:"gender",value:"male",checked:t==="male",onChange:()=>n("male")}),S.jsx("span",{children:"For boy"})]})]}),S.jsxs("div",{children:[S.jsx(Ti,{children:"Your weight in kilograms:"}),S.jsx(Ts,{type:"text",placeholder:"0",value:r,onChange:v=>o(v.target.value)})]}),S.jsxs("div",{children:[S.jsx(Ti,{children:"Time of active participation in sports or other activities with a high physical load:"}),S.jsx(Ts,{type:"text",placeholder:"0",value:i,onChange:v=>a(v.target.value)})]}),S.jsxs(u_,{children:["The required amount of water in liters per day:"," ",S.jsxs("strong",{children:[l,"L"]})]}),S.jsxs("div",{children:[S.jsx(Yh,{children:"Write down how much water you will drink:"}),S.jsx(Ts,{type:"text",placeholder:"0",value:u,onChange:v=>f(v.target.value)})]}),S.jsx(c_,{onClick:h,children:"Save"})]})})]})})};f_.propTypes={onClose:uo.func.isRequired};const X_=C.div`
    position: absolute;
    top: 0;
    right:0;
...
`,O_=()=>{const[e,t]=b.useState(!1),{userName:n,avatarURL:r}=Wy(KP),o=()=>{t(!e)},i=n?n.charAt(0).toUpperCase():"V",a=()=>n&&r?{name:n,avatar:r}:n?{name:n,avatar:i}:{name:i,avatar:i},{name:l,avatar:s}=a();return S.jsxs(S_,{children:[S.jsx(b_,{children:l}),S.jsxs(k_,{onClick:o,children:[r?S.jsx(E_,{src:s,alt:""}):S.jsx(P_,{children:s}),S.jsx(__,{children:S.jsx("use",{href:`${gn}#icon-arrow-down`})})]}),e&&S.jsx(j_,{})]})},C_=C.div`
  position: absolute;
  top: 56px;
  width: 118px;
  padding: 16px;
...
`,j_=()=>{const[e,t]=b.useState(!1),[n,r]=b.useState(!1),o=()=>{t(!0)},i=()=>{t(!1)},a=()=>{r(!0)},l=()=>{r(!1)};return S.jsx(S.Fragment,{children:S.jsx("div",{children:S.jsx(C_,{children:S.jsxs("ul",{children:[S.jsxs(om,{children:[S.jsx(nm,{width:"16px",height:"16px",children:S.jsx("use",{href:`${gn}#icon-settings`})}),S.jsxs(rm,{type:"button",onClick:o,children:["Setting",e&&S.jsx(x_,{onClose:i})]})]}),S.jsxs(om,{children:[S.jsx(nm,{width:"16px",height:"16px",children:S.jsx("use",{href:`${gn}#icon-exit`})}),S.jsxs(rm,{type:"button",onClick:a,children:["Log out",n&&S.jsx(L_,{onClose:l})]})]})]})})})})},R_=C.h2`
  margin-bottom: 24px;
  color: ${({theme:e})=>e.color.black};
  font-family: Roboto;
  font-size: 18px;
...
`,A_=C.div`
  ...
  padding-right: 24px;
  padding-bottom: 32px;
`,L_=({onClose:e})=>{const t=SS();return S.jsx(S.Fragment,{children:S.jsx(zl,{onClose:e,title:"Log out",children:S.jsxs(A_,{children:[S.jsx(R_,{children:"Do you really want to leave?"}),S.jsxs(N_,{children:[S.jsx("li",{children:S.jsx(T_,{type:"button",onClick:e,children:"Cancel"})}),S.jsx("li",{children:S.jsx($_,{type:"button",onClick:()=>t(Pv()),children:"Log out"})})]})]})})})},xO=C.img`
  position: absolute;
