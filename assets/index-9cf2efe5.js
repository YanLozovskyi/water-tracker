...
`,eF=()=>{const e=w.useRef(),[t,n]=w.useState(!1),{userName:r,avatarURL:i}=jr(Dx),o=()=>{n(!t)},a=r?r.charAt(0).toUpperCase():"V",s=()=>r&&i?{name:r,avatar:i}:r||i?{name:r||a,avatar:i||a}:{name:a,avatar:a},{name:l,avatar:u}=s();return b.jsxs(q3,{children:[b.jsx(Y3,{children:l}),b.jsxs(Q3,{onClick:o,ref:e,children:[i?b.jsx(X3,{src:u,alt:"user-avatar"}):b.jsx(J3,{children:u}),b.jsx(Z3,{children:b.jsx("use",{href:`${kt}#icon-arrow-down`})})]}),t&&b.jsx(nF,{setOnShowDropdown:n,parentRef:e})]})},tF=$.div`
  position: absolute;
  top: 38px;
  left: -53px;
  width: 118px;
