...
`,F=()=>{const t=W(),n=C(),s=n[0].get("token");console.log(n),console.log(n[0]),console.log(n[0].get("token"));const i=g();return P.useEffect(()=>{if(s)try{t(S(s)),t(D()).then(a=>{a.error||i("/home")})}catch(a){console.log(a.message)}},[t,i,s]),e.jsx(U,{children:e.jsx(V,{children:e.jsx(B,{})})})};export{F as default};
