 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(F,V){var H=F.length;F.push(V);e:for(;0<H;){var ie=H-1>>>1,R=F[ie];if(0<i(R,V))F[ie]=V,F[H]=R,H=ie;else break e}}function n(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var V=F[0],H=F.pop();if(H!==V){F[0]=H;e:for(var ie=0,R=F.length,z=R>>>1;ie<z;){var M=2*(ie+1)-1,W=F[M],T=M+1,q=F[T];if(0>i(W,H))T<R&&0>i(q,W)?(F[ie]=q,F[T]=H,ie=T):(F[ie]=W,F[M]=H,ie=M);else if(T<R&&0>i(q,H))F[ie]=q,F[T]=H,ie=T;else break e}}return V}function i(F,V){var H=F.sortIndex-V.sortIndex;return H!==0?H:F.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,d=3,v=!1,g=!1,m=!1,w=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(F){for(var V=n(u);V!==null;){if(V.callback===null)r(u);else if(V.startTime<=F)r(u),V.sortIndex=V.expirationTime,t(l,V);else break;V=n(u)}}function S(F){if(m=!1,y(F),!g)if(n(l)!==null)g=!0,Ft(E);else{var V=n(u);V!==null&&We(S,V.startTime-F)}}function E(F,V){g=!1,m&&(m=!1,h(A),A=-1),v=!0;var H=d;try{for(y(V),c=n(l);c!==null&&(!(c.expirationTime>V)||F&&!G());){var ie=c.callback;if(typeof ie=="function"){c.callback=null,d=c.priorityLevel;var R=ie(c.expirationTime<=V);V=e.unstable_now(),typeof R=="function"?c.callback=R:c===n(l)&&r(l),y(V)}else r(l);c=n(l)}if(c!==null)var z=!0;else{var M=n(u);M!==null&&We(S,M.startTime-V),z=!1}return z}finally{c=null,d=H,v=!1}}var _=!1,$=null,A=-1,B=5,D=-1;function G(){return!(e.unstable_now()-D<B)}function we(){if($!==null){var F=e.unstable_now();D=F;var V=!0;try{V=$(!0,F)}finally{V?Q():(_=!1,$=null)}}else _=!1}var Q;if(typeof p=="function")Q=function(){p(we)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,Te=$e.port2;$e.port1.onmessage=we,Q=function(){Te.postMessage(null)}}else Q=function(){w(we,0)};function Ft(F){$=F,_||(_=!0,Q())}function We(F,V){A=w(function(){F(e.unstable_now())},V)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(F){F.callback=null},e.unstable_continueExecution=function(){g||v||(g=!0,Ft(E))},e.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<F?Math.floor(1e3/F):5},e.unstable_getCurrentPriorityLevel=function(){return d},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(F){switch(d){case 1:case 2:case 3:var V=3;break;default:V=d}var H=d;d=V;try{return F()}finally{d=H}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(F,V){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var H=d;d=F;try{return V()}finally{d=H}},e.unstable_scheduleCallback=function(F,V,H){var ie=e.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?ie+H:ie):H=ie,F){case 1:var R=-1;break;case 2:R=250;break;case 5:R=1073741823;break;case 4:R=1e4;break;default:R=5e3}return R=H+R,F={id:f++,callback:V,priorityLevel:F,startTime:H,expirationTime:R,sortIndex:-1},H>ie?(F.sortIndex=H,t(u,F),n(l)===null&&F===n(u)&&(m?(h(A),A=-1):m=!0,We(S,H-ie))):(F.sortIndex=R,t(l,F),g||v||(g=!0,Ft(E))),F},e.unstable_shouldYield=G,e.unstable_wrapCallback=function(F){var V=d;return function(){var H=d;d=V;try{return F.apply(this,arguments)}finally{d=H}}}})(x0);w0.exports=x0;var wS=w0.exports;/**
 * @license React
...
`,_t="/water-tracker/assets/sprite-c35e1970.svg",Wl=({onShow:e=!0,children:t,title:n,onClose:r})=>{const i=document.querySelector("#modal-root"),o=x.useRef(null),a=x.useRef(null);return x.useEffect(()=>{const s=u=>{document.body.style.overflow=u?"hidden":"auto"};(e||i.children.length!==0)&&s(!0);const l=u=>{u.code==="Escape"&&r()};return window.addEventListener("keydown",l),()=>{s(!1),window.removeEventListener("keydown",l)}},[i.children.length,e,r]),Vd.createPortal(b.jsx(U$,{onClick:r,ref:a,children:b.jsxs(B$,{onClick:s=>s.stopPropagation(),ref:o,children:[b.jsxs(W$,{children:[b.jsx("h2",{children:n}),b.jsx(V$,{onClick:r,children:b.jsx(H$,{children:b.jsx("use",{href:`${_t}#icon-outline`})})})]}),b.jsx("div",{children:t})]})}),i)};Wl.propTypes={onClose:no.func.isRequired,children:no.node.isRequired,onShow:no.bool,title:no.string.isRequired};const G$=k.div`
  margin: 0 auto;
  padding-right: 20px;
  padding-left: 20px;
 ...
 *
 * @license MIT
 */function Ws(){return Ws=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ws.apply(this,arguments)}function Bw(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function TC(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function CC(e,t){return e.button===0&&(!t||t==="_self")&&!TC(e)}const PC=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],jC=["aria-current","caseSensitive","className","end","style","to","unstable_viewTransition","children"],RC=x.createContext({isTransitioning:!1}),AC="startTransition",Gg=rc[AC];function FC(e){let{basename:t,children:n,future:r,window:i}=e,o=x.useRef();o.current==null&&(o.current=LT({window:i,v5Compat:!0}));let a=o.current,[s,l]=x.useState({action:a.action,location:a.location}),{v7_startTransition:u}=r||{},f=x.useCallback(c=>{u&&Gg?Gg(()=>l(c)):l(c)},[l,u]);return x.useLayoutEffect(()=>a.listen(f),[a,f]),x.createElement(OC,{basename:t,children:n,location:s.location,navigationType:s.action,navigator:a,future:r})}const NC=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",IC=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,LC=x.forwardRef(function(t,n){let{onClick:r,relative:i,reloadDocument:o,replace:a,state:s,target:l,to:u,preventScrollReset:f,unstable_viewTransition:c}=t,d=Bw(t,PC),{basename:v}=x.useContext(On),g,m=!1;if(typeof u=="string"&&IC.test(u)&&(g=u,NC))try{let y=new URL(window.location.href),S=u.startsWith("//")?new URL(y.protocol+u):new URL(u),E=Vo(S.pathname,v);S.origin===y.origin&&E!=null?u=E+S.search+S.hash:m=!0}catch{}let w=lC(u,{relative:i}),h=DC(u,{replace:a,state:s,target:l,preventScrollReset:f,relative:i,unstable_viewTransition:c});function p(y){r&&r(y),y.defaultPrevented||h(y)}return x.createElement("a",Ws({},d,{href:g||w,onClick:m||o?r:p,ref:n,target:l}))}),Go=x.forwardRef(function(t,n){let{"aria-current":r="page",caseSensitive:i=!1,className:o="",end:a=!1,style:s,to:l,unstable_viewTransition:u,children:f}=t,c=Bw(t,jC),d=Gl(l,{relative:c.relative}),v=Ii(),g=x.useContext(Nw),{navigator:m}=x.useContext(On),w=g!=null&&MC(d)&&u===!0,h=m.encodeLocation?m.encodeLocation(d).pathname:d.pathname,p=v.pathname,y=g&&g.navigation&&g.navigation.location?g.navigation.location.pathname:null;i||(p=p.toLowerCase(),y=y?y.toLowerCase():null,h=h.toLowerCase());const S=h!=="/"&&h.endsWith("/")?h.length-1:h.length;let E=p===h||!a&&p.startsWith(h)&&p.charAt(S)==="/",_=y!=null&&(y===h||!a&&y.startsWith(h)&&y.charAt(h.length)==="/"),$={isActive:E,isPending:_,isTransitioning:w},A=E?r:void 0,B;typeof o=="function"?B=o($):B=[o,E?"active":null,_?"pending":null,w?"transitioning":null].filter(Boolean).join(" ");let D=typeof s=="function"?s($):s;return x.createElement(LC,Ws({},c,{"aria-current":A,className:B,ref:n,style:D,to:l,unstable_viewTransition:u}),typeof f=="function"?f($):f)});var Ef;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(Ef||(Ef={}));var Kg;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Kg||(Kg={}));function zC(e){let t=x.useContext(Vl);return t||_e(!1),t}function DC(e,t){let{target:n,replace:r,state:i,preventScrollReset:o,relative:a,unstable_viewTransition:s}=t===void 0?{}:t,l=zw(),u=Ii(),f=Gl(e,{relative:a});return x.useCallback(c=>{if(CC(c,n)){c.preventDefault();let d=r!==void 0?r:Us(u)===Us(f);l(e,{replace:d,state:i,preventScrollReset:o,relative:a,unstable_viewTransition:s})}},[u,l,f,r,i,n,e,o,a,s])}function MC(e,t){t===void 0&&(t={});let n=x.useContext(RC);n==null&&_e(!1);let{basename:r}=zC(Ef.useViewTransitionState),i=Gl(e,{relative:t.relative});if(!n.isTransitioning)return!1;let o=Vo(n.currentLocation.pathname,r)||n.currentLocation.pathname,a=Vo(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Sf(i.pathname,a)!=null||Sf(i.pathname,o)!=null}const Yg="/water-tracker/assets/Logo-890d13ba.png",qg=k.img`
  width: 102px;
  height: 48px;
`,Op=e=>e.auth.user,Kl=e=>e.auth.isLoggedIn,UC=e=>e.auth.isRefreshing,BC=()=>{const e=ur(Kl);return b.jsx("div",{children:e?b.jsx(Go,{to:"/home",children:b.jsx(qg,{src:Yg,alt:"logo"})}):b.jsx(Go,{to:"/",children:b.jsx(qg,{src:Yg,alt:"logo"})})})},WC=k.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding-top: 12px;
...
`,dF=()=>{const e=x.useRef(),[t,n]=x.useState(!1),{name:r,avatarURL:i}=ur(Op),o=()=>{n(!t)},a=r?r.charAt(0).toUpperCase():"V",s=()=>r&&i?{userName:r,avatar:i}:r||i?{userName:r||a,avatar:i||a}:{userName:a,avatar:a},{userName:l,avatar:u}=s();return b.jsxs(aF,{children:[b.jsx(sF,{children:l}),b.jsxs(lF,{onClick:o,ref:e,children:[i?b.jsx(uF,{src:u,alt:"user-avatar"}):b.jsx(cF,{children:u}),b.jsx(fF,{children:b.jsx("use",{href:`${_t}#icon-arrow-down`})})]}),t&&b.jsx(hF,{setOnShowDropdown:n,parentRef:e})]})},pF=k.div`
  position: absolute;
  top: 38px;
  left: -53px;
  width: 118px;
...
`,hF=({setOnShowDropdown:e,parentRef:t})=>{const n=x.useRef(),[r,i]=x.useState(!1),[o,a]=x.useState(!1);return x.useEffect(()=>{const s=u=>{n.current&&!n.current.contains(u.target)&&t.current&&!t.current.contains(u.target)&&e(!1)},l=u=>{u.code==="Escape"&&e(!1)};return window.addEventListener("keydown",l),document.addEventListener("click",s),()=>{document.removeEventListener("click",s),window.removeEventListener("keydown",l)}},[t,e]),b.jsx(b.Fragment,{children:b.jsxs(pF,{ref:n,children:[b.jsxs("ul",{children:[b.jsxs(Vy,{children:[b.jsx(By,{width:"16px",height:"16px",children:b.jsx("use",{href:`${_t}#icon-settings`})}),b.jsx(Wy,{type:"button",onClick:()=>{i(!0)},children:"Setting"})]}),b.jsxs(Vy,{children:[b.jsx(By,{width:"16px",height:"16px",children:b.jsx("use",{href:`${_t}#icon-exit`})}),b.jsx(Wy,{type:"button",onClick:()=>{a(!0)},children:"Log out"})]})]}),r&&b.jsx(tF,{onClose:()=>{i(!1)}}),o&&b.jsx(xF,{onClose:()=>{a(!1)}})]})})},mF=k.h2`
  margin-bottom: 24px;
  color: ${({theme:e})=>e.color.black};
  font-family: Roboto;
  font-size: 18px;
...
`,wF=k.div`
  ...
  padding-right: 24px;
  padding-bottom: 32px;
`,xF=({onClose:e})=>{const t=Il();return b.jsx(b.Fragment,{children:b.jsx(Wl,{onClose:e,title:"Log out",children:b.jsxs(wF,{children:[b.jsx(mF,{children:"Do you really want to leave?"}),b.jsxs(vF,{children:[b.jsx("li",{children:b.jsx(yF,{type:"button",onClick:e,children:"Cancel"})}),b.jsx("li",{children:b.jsx(gF,{type:"button",onClick:()=>t(cw()),children:"Log out"})})]})]})})})},UN=k.div`
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,bF="modulepreload",SF=function(e){return"/water-tracker/"+e},Hy={},zi=function(t,n,r){if(!n||n.length===0)return t();const i=document.getElementsByTagName("link");return Promise.all(n.map(o=>{if(o=SF(o),o in Hy)return;Hy[o]=!0;const a=o.endsWith(".css"),s=a?'[rel="stylesheet"]':"";if(!!r)for(let f=i.length-1;f>=0;f--){const c=i[f];if(c.href===o&&(!a||c.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${s}`))return;const u=document.createElement("link");if(u.rel=a?"stylesheet":bF,a||(u.as="script",u.crossOrigin=""),u.href=o,document.head.appendChild(u),a)return new Promise((f,c)=>{u.addEventListener("load",f),u.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t()).catch(o=>{const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o})},kF=({component:e,redirectTo:t})=>ur(Kl)?b.jsx(e,{}):b.jsx(Uw,{to:t}),Na=({component:e,redirectTo:t})=>ur(Kl)?b.jsx(Uw,{to:t}):e,EF=()=>b.jsxs(b.Fragment,{children:[b.jsx(VC,{}),b.jsx("main",{children:b.jsx(x.Suspense,{fallback:b.jsx(Sp,{}),children:b.jsx(_C,{})})})]}),_F=x.lazy(()=>zi(()=>import("./Welcome-5cf2c35e.js"),["assets/Welcome-5cf2c35e.js","assets/Section-b29cfb93.js"])),OF=x.lazy(()=>zi(()=>import("./Home-f588a93e.js"),["assets/Home-f588a93e.js","assets/Section-b29cfb93.js","assets/bubbleTablet@2x-6e22c1d3.js"])),$F=x.lazy(()=>zi(()=>import("./SignIn-97a8e183.js"),["assets/SignIn-97a8e183.js","assets/Section-b29cfb93.js","assets/bubbleTablet@2x-6e22c1d3.js"])),TF=x.lazy(()=>zi(()=>import("./SignUp-6cba370d.js"),["assets/SignUp-6cba370d.js","assets/Section-b29cfb93.js","assets/bubbleTablet@2x-6e22c1d3.js"])),CF=x.lazy(()=>zi(()=>import("./Error-ee77e433.js"),["assets/Error-ee77e433.js","assets/Section-b29cfb93.js"])),PF=x.lazy(()=>zi(()=>import("./ForgotPassword-7cb11787.js"),["assets/ForgotPassword-7cb11787.js","assets/Section-b29cfb93.js"])),jF=()=>{const e=Il(),t=ur(UC);return x.useEffect(()=>{e(os())},[e]),t?b.jsx(Sp,{}):b.jsx($C,{children:b.jsxs(jn,{path:"/",element:b.jsx(EF,{}),children:[b.jsx(jn,{index:!0,element:b.jsx(Na,{component:b.jsx(_F,{}),redirectTo:"/home"})}),b.jsx(jn,{path:"home",element:b.jsx(kF,{component:OF,redirectTo:"/"})}),b.jsx(jn,{path:"signin",element:b.jsx(Na,{component:b.jsx($F,{}),redirectTo:"/home"})}),b.jsx(jn,{path:"signup",element:b.jsx(Na,{component:b.jsx(TF,{}),redirectTo:"/home"})}),b.jsx(jn,{path:"forgot-password",element:b.jsx(Na,{component:b.jsx(PF,{}),redirectTo:"/signin"})}),b.jsx(jn,{path:"*",element:b.jsx(CF,{})})]})})},RF=sc.createRoot(document.getElementById("root"));RF.render(b.jsx(He.StrictMode,{children:b.jsxs(g0,{theme:hf,children:[b.jsx(y0,{styles:C$}),b.jsx(tE,{store:mw,children:b.jsx(P1,{loading:b.jsx(Sp,{}),persistor:k$,children:b.jsx(FC,{basename:"/water-tracker",children:b.jsx(jF,{})})})})]})}));export{oN as $,YF as A,qN as B,e5 as C,FF as D,Il as E,Wl as F,qF as G,BN as H,GN as I,QF as J,mN as K,t5 as L,pN as M,hN as N,ZN as O,VN as P,JF as Q,XF as R,tN as S,KN as T,nN as U,eN as V,UN as W,ZF as X,HF as Y,rN as Z,iN as _,WN as a,aN as a0,sN as a1,y$ as a2,g$ as a3,lN as a4,fN as a5,dN as a6,uN as a7,cN as a8,gN as a9,DN as aA,e$ as aB,Go as aC,n5 as aD,r5 as aE,G$ as aF,yN as aa,vN as ab,wN as ac,v$ as ad,xN as ae,kN as af,SN as ag,bN as ah,EN as ai,ON as aj,_N as ak,$N as al,TN as am,CN as an,jN as ao,PN as ap,NN as aq,LN as ar,AN as as,FN as at,RN as au,zN as av,IN as aw,nF as ax,MN as ay,t$ as az,HN as b,YN as c,QN as d,XN as e,JN as f,ur as g,Op as h,IF as i,b as j,eP as k,NF as l,LF as m,k as n,zF as o,DF as p,UF as q,x as r,_t as s,MF as t,zw as u,BF as v,VF as w,WF as x,GF as y,KF as z};
